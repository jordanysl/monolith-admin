...
import { GetUserInfoModel, LoginParams, ThirdLoginParams } from '@/api-service/sys/model/userModel';
import { doLogout, loginApi, phoneLoginApi, thirdLogin } from '@/api-service/sys/user';
...
export const useUserStore = defineStore({
  ...
  actions: {
    ...
    confirmLoginOut() {
      ...
      createConfirm({
        iconType: 'warning',
        title: () => h('span', t('sys.app.logoutTip') || '温馨提醒'),
        content: () => h('span', t('sys.app.logoutMessage') || '是否确认退出系统?'),
        onOk: async () => {
