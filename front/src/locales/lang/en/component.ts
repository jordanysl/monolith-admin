export default {
  component: {
    ...
    countdown: {
      ...
      sendText: 'Reacquire in {seconds}s',
    },
    cropper: {
    ...
    form: {
      putAway: 'Put away',
      unfold: 'Unfold',
      maxTip: 'The number of characters should be less than {max}',
    ...
    upload: {
      ...
      accept: 'Support {acceptFormat} format',
      acceptUpload: 'Only upload files in {acceptFormat} format',
      maxSize: 'A single file does not exceed {maxSize}MB ',
      maxSizeMultiple: 'Only upload files up to {maxSize}MB!',
      maxNumber: 'Only upload up to {maxNumber} files',
      legend: 'Legend',
      fileName: 'File name',
      fileSize: 'File size',
