...
import CommonFieldDataEdit from './common-field-data-edit.vue';
import CommonFieldDataDetail from './common-field-data-detail.vue';
...
export default defineComponent({
  ...
  async setup() {
    ...
    const apis = {
      ...
      deleteById: apiService.settings.commonFieldDataService.delete,
      deleteByIds: apiService.settings.commonFieldDataService.deleteByIds,
      update: apiService.settings.commonFieldDataService.update,
    };
    const pageConfig = {
      title: '通用字段数据列表',
      baseRouteName: 'systemCommonFieldData',
    };
          ...
          if (operation) {
            if (operation.click) {
              ...
              switch (operation.containerType) {
                case 'modal':
                  this.modalConfig.componentName = 'common-field-data-edit';
                  this.modalConfig.entityId = row.id;
                  this.setModalProps({ visible: true });
                  break;
                case 'drawer':
                  this.drawerConfig.componentName = 'common-field-data-edit';
        ...
        case 'detail':
          if (operation) {
            if (operation.click) {
              ...
              switch (operation.containerType) {
                case 'modal':
                  this.modalConfig.componentName = 'common-field-data-detail';
                  this.modalConfig.entityId = row.id;
                  this.setModalProps({ visible: true });
                  break;
                case 'drawer':
                  this.drawerConfig.componentName = 'common-field-data-detail';
                  this.drawerConfig.entityId = row.id;
                  this.setDrawerProps({ visible: true });
                  break;
                case 'route':
