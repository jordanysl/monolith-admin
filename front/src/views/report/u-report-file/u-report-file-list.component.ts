...
export default defineComponent({
  ...
  async setup() {
    ...
    const apis = {
      ...
      updateBySpecifiedField: apiService.report.uReportFileService.updateBySpecifiedField,
    };
    const pageConfig = {
      title: '报表存储列表',
      ...
      toolButtons: [
        {
          ...
          click: () => {
            modalConfig.componentName = 'UReportFileEdit';
          ...
          if (operation) {
            if (operation.click) {
              ...
              switch (operation.containerType) {
                case 'modal':
                  this.modalConfig.componentName = 'u-report-file-edit';
                  this.modalConfig.entityId = row.id;
                  this.setModalProps({ visible: true });
                  break;
                case 'drawer':
                  this.drawerConfig.componentName = 'u-report-file-edit';
        ...
        case 'detail':
          if (operation) {
            if (operation.click) {
              ...
              switch (operation.containerType) {
                case 'modal':
                  this.modalConfig.componentName = 'u-report-file-detail';
                  this.modalConfig.entityId = row.id;
                  this.setModalProps({ visible: true });
                  break;
                case 'drawer':
                  this.drawerConfig.componentName = 'u-report-file-detail';
                  this.drawerConfig.entityId = row.id;
                  this.setDrawerProps({ visible: true });
                  break;
                case 'route':
