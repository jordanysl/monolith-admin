...
import SmsConfigEdit from './sms-config-edit.vue';
import SmsConfigDetail from './sms-config-detail.vue';
...
export default defineComponent({
  ...
  async setup() {
    ...
    const apis = {
      smsConfigService: apiService.files.smsConfigService,
      find: apiService.files.smsConfigService.retrieve,
      deleteById: apiService.files.smsConfigService.delete,
      deleteByIds: apiService.files.smsConfigService.deleteByIds,
      update: apiService.files.smsConfigService.update,
    };
    const pageConfig = {
      title: '短信配置列表',
