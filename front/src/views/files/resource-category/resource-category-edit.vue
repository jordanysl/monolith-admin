...
export default defineComponent({
  ...
  async setup(props) {
    ...
    const relationshipApis: any = {
      ...
      'parent.id': apiService.files.resourceCategoryService.tree,
    };
    ...
    const resourceCategory = reactive<IResourceCategory>(new ResourceCategory());
    ...
    const saveOrUpdate = () => {
      validate()
        .then(result => {
          if (result) {
            Object.assign(resourceCategory, result);
            saveOrUpdateApi(resourceCategory)
              .then(res => {
                Object.assign(resourceCategory, res);
            ...
            <div>
              <a-card
                {...{
                  ...
                  title: resourceCategoryId.value ? '编辑资源分类' : '新增资源分类',
                  bordered: false,
                  size: 'small',
                }}
