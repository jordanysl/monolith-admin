...
public class CommonFieldDataResourceIT {
    ...
    void createCommonFieldData() throws Exception {
        ...
        assertThat(testCommonFieldData.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testCommonFieldData.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllCommonFieldDataByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where delFlag equals to DEFAULT_DEL_FLAG
        defaultCommonFieldDataShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the commonFieldDataList where delFlag equals to UPDATED_DEL_FLAG
        defaultCommonFieldDataShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultCommonFieldDataShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the commonFieldDataList where delFlag equals to UPDATED_DEL_FLAG
        defaultCommonFieldDataShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where delFlag is not null
        defaultCommonFieldDataShouldBeFound("delFlag.specified=true");

        // Get all the commonFieldDataList where delFlag is null
        defaultCommonFieldDataShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime equals to UPDATED_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime equals to UPDATED_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime is not null
        defaultCommonFieldDataShouldBeFound("deletedTime.specified=true");

        // Get all the commonFieldDataList where deletedTime is null
        defaultCommonFieldDataShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime is less than UPDATED_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllCommonFieldDataByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        commonFieldDataRepository.save(commonFieldData);

        // Get all the commonFieldDataList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultCommonFieldDataShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the commonFieldDataList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultCommonFieldDataShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingCommonFieldData() throws Exception {
        ...
        assertThat(testCommonFieldData.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testCommonFieldData.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
    ...
    void putNonExistingCommonFieldData() throws Exception {
        int databaseSizeBeforeUpdate = commonFieldDataRepository.findAll().size();
        commonFieldData.setId(count.incrementAndGet());
