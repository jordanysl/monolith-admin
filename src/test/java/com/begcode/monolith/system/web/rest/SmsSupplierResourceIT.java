...
public class SmsSupplierResourceIT {
    ...
    void createSmsSupplier() throws Exception {
        ...
        assertThat(testSmsSupplier.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testSmsSupplier.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllSmsSuppliersByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where delFlag equals to DEFAULT_DEL_FLAG
        defaultSmsSupplierShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the smsSupplierList where delFlag equals to UPDATED_DEL_FLAG
        defaultSmsSupplierShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultSmsSupplierShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the smsSupplierList where delFlag equals to UPDATED_DEL_FLAG
        defaultSmsSupplierShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where delFlag is not null
        defaultSmsSupplierShouldBeFound("delFlag.specified=true");

        // Get all the smsSupplierList where delFlag is null
        defaultSmsSupplierShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime is not null
        defaultSmsSupplierShouldBeFound("deletedTime.specified=true");

        // Get all the smsSupplierList where deletedTime is null
        defaultSmsSupplierShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime is less than UPDATED_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsSuppliersByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        smsSupplierRepository.save(smsSupplier);

        // Get all the smsSupplierList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultSmsSupplierShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the smsSupplierList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultSmsSupplierShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingSmsSupplier() throws Exception {
        ...
        assertThat(testSmsSupplier.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testSmsSupplier.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
    ...
    void putNonExistingSmsSupplier() throws Exception {
        int databaseSizeBeforeUpdate = smsSupplierRepository.findAll().size();
        smsSupplier.setId(count.incrementAndGet());
    ...
    void partialUpdateSmsSupplierWithPatch() throws Exception {
        ...
        partialUpdatedSmsSupplier.remark(UPDATED_REMARK).delFlag(UPDATED_DEL_FLAG).deletedTime(UPDATED_DELETED_TIME);
