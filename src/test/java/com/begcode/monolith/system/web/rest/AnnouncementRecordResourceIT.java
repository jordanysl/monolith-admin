...
public class AnnouncementRecordResourceIT {
    ...
    void createAnnouncementRecord() throws Exception {
        ...
        assertThat(testAnnouncementRecord.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testAnnouncementRecord.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllAnnouncementRecordsByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where delFlag equals to DEFAULT_DEL_FLAG
        defaultAnnouncementRecordShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the announcementRecordList where delFlag equals to UPDATED_DEL_FLAG
        defaultAnnouncementRecordShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultAnnouncementRecordShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the announcementRecordList where delFlag equals to UPDATED_DEL_FLAG
        defaultAnnouncementRecordShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where delFlag is not null
        defaultAnnouncementRecordShouldBeFound("delFlag.specified=true");

        // Get all the announcementRecordList where delFlag is null
        defaultAnnouncementRecordShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime equals to UPDATED_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime equals to UPDATED_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime is not null
        defaultAnnouncementRecordShouldBeFound("deletedTime.specified=true");

        // Get all the announcementRecordList where deletedTime is null
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime is less than UPDATED_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementRecordsByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        announcementRecordRepository.save(announcementRecord);

        // Get all the announcementRecordList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultAnnouncementRecordShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the announcementRecordList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultAnnouncementRecordShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingAnnouncementRecord() throws Exception {
        ...
        assertThat(testAnnouncementRecord.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testAnnouncementRecord.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
