...
public class SmsMessageResourceIT {
    ...
    void createSmsMessage() throws Exception {
        ...
        assertThat(testSmsMessage.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testSmsMessage.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllSmsMessagesByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where delFlag equals to DEFAULT_DEL_FLAG
        defaultSmsMessageShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the smsMessageList where delFlag equals to UPDATED_DEL_FLAG
        defaultSmsMessageShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultSmsMessageShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the smsMessageList where delFlag equals to UPDATED_DEL_FLAG
        defaultSmsMessageShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where delFlag is not null
        defaultSmsMessageShouldBeFound("delFlag.specified=true");

        // Get all the smsMessageList where delFlag is null
        defaultSmsMessageShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the smsMessageList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the smsMessageList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime is not null
        defaultSmsMessageShouldBeFound("deletedTime.specified=true");

        // Get all the smsMessageList where deletedTime is null
        defaultSmsMessageShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the smsMessageList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the smsMessageList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the smsMessageList where deletedTime is less than UPDATED_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSmsMessagesByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        smsMessageRepository.save(smsMessage);

        // Get all the smsMessageList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultSmsMessageShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the smsMessageList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultSmsMessageShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingSmsMessage() throws Exception {
        ...
        assertThat(testSmsMessage.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testSmsMessage.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
