...
public class AnnouncementResourceIT {
    ...
    void createAnnouncement() throws Exception {
        ...
        assertThat(testAnnouncement.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testAnnouncement.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllAnnouncementsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultAnnouncementShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the announcementList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultAnnouncementShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultAnnouncementShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the announcementList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultAnnouncementShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where createdDate is less than DEFAULT_CREATED_DATE
        defaultAnnouncementShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the announcementList where createdDate is less than UPDATED_CREATED_DATE
        defaultAnnouncementShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultAnnouncementShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the announcementList where createdDate is greater than SMALLER_CREATED_DATE
        defaultAnnouncementShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllAnnouncementsByLastModifiedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where lastModifiedDate is greater than or equal to DEFAULT_LAST_MODIFIED_DATE
        defaultAnnouncementShouldBeFound("lastModifiedDate.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the announcementList where lastModifiedDate is greater than or equal to UPDATED_LAST_MODIFIED_DATE
        defaultAnnouncementShouldNotBeFound("lastModifiedDate.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByLastModifiedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where lastModifiedDate is less than or equal to DEFAULT_LAST_MODIFIED_DATE
        defaultAnnouncementShouldBeFound("lastModifiedDate.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the announcementList where lastModifiedDate is less than or equal to SMALLER_LAST_MODIFIED_DATE
        defaultAnnouncementShouldNotBeFound("lastModifiedDate.lessThanOrEqual=" + SMALLER_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByLastModifiedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where lastModifiedDate is less than DEFAULT_LAST_MODIFIED_DATE
        defaultAnnouncementShouldNotBeFound("lastModifiedDate.lessThan=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the announcementList where lastModifiedDate is less than UPDATED_LAST_MODIFIED_DATE
        defaultAnnouncementShouldBeFound("lastModifiedDate.lessThan=" + UPDATED_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByLastModifiedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where lastModifiedDate is greater than DEFAULT_LAST_MODIFIED_DATE
        defaultAnnouncementShouldNotBeFound("lastModifiedDate.greaterThan=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the announcementList where lastModifiedDate is greater than SMALLER_LAST_MODIFIED_DATE
        defaultAnnouncementShouldBeFound("lastModifiedDate.greaterThan=" + SMALLER_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where delFlag equals to DEFAULT_DEL_FLAG
        defaultAnnouncementShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the announcementList where delFlag equals to UPDATED_DEL_FLAG
        defaultAnnouncementShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultAnnouncementShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the announcementList where delFlag equals to UPDATED_DEL_FLAG
        defaultAnnouncementShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where delFlag is not null
        defaultAnnouncementShouldBeFound("delFlag.specified=true");

        // Get all the announcementList where delFlag is null
        defaultAnnouncementShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the announcementList where deletedTime equals to UPDATED_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the announcementList where deletedTime equals to UPDATED_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime is not null
        defaultAnnouncementShouldBeFound("deletedTime.specified=true");

        // Get all the announcementList where deletedTime is null
        defaultAnnouncementShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the announcementList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the announcementList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the announcementList where deletedTime is less than UPDATED_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllAnnouncementsByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        announcementRepository.save(announcement);

        // Get all the announcementList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultAnnouncementShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the announcementList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultAnnouncementShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingAnnouncement() throws Exception {
        ...
        assertThat(testAnnouncement.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testAnnouncement.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
