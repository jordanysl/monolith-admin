...
public class TaskJobConfigResourceIT {
    ...
    void createTaskJobConfig() throws Exception {
        ...
        assertThat(testTaskJobConfig.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testTaskJobConfig.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllTaskJobConfigsByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where delFlag equals to DEFAULT_DEL_FLAG
        defaultTaskJobConfigShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the taskJobConfigList where delFlag equals to UPDATED_DEL_FLAG
        defaultTaskJobConfigShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultTaskJobConfigShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the taskJobConfigList where delFlag equals to UPDATED_DEL_FLAG
        defaultTaskJobConfigShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where delFlag is not null
        defaultTaskJobConfigShouldBeFound("delFlag.specified=true");

        // Get all the taskJobConfigList where delFlag is null
        defaultTaskJobConfigShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime equals to UPDATED_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime equals to UPDATED_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime is not null
        defaultTaskJobConfigShouldBeFound("deletedTime.specified=true");

        // Get all the taskJobConfigList where deletedTime is null
        defaultTaskJobConfigShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime is less than UPDATED_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllTaskJobConfigsByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        taskJobConfigRepository.save(taskJobConfig);

        // Get all the taskJobConfigList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultTaskJobConfigShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the taskJobConfigList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultTaskJobConfigShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingTaskJobConfig() throws Exception {
        ...
        assertThat(testTaskJobConfig.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testTaskJobConfig.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
    ...
    void putNonExistingTaskJobConfig() throws Exception {
        int databaseSizeBeforeUpdate = taskJobConfigRepository.findAll().size();
        taskJobConfig.setId(count.incrementAndGet());
