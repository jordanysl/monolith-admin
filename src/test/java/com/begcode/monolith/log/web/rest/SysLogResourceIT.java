...
public class SysLogResourceIT {
    ...
    void createSysLog() throws Exception {
        ...
        assertThat(testSysLog.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testSysLog.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllSysLogsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultSysLogShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the sysLogList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultSysLogShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultSysLogShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the sysLogList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultSysLogShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where createdDate is less than DEFAULT_CREATED_DATE
        defaultSysLogShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the sysLogList where createdDate is less than UPDATED_CREATED_DATE
        defaultSysLogShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultSysLogShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the sysLogList where createdDate is greater than SMALLER_CREATED_DATE
        defaultSysLogShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllSysLogsByLastModifiedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where lastModifiedDate is greater than or equal to DEFAULT_LAST_MODIFIED_DATE
        defaultSysLogShouldBeFound("lastModifiedDate.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the sysLogList where lastModifiedDate is greater than or equal to UPDATED_LAST_MODIFIED_DATE
        defaultSysLogShouldNotBeFound("lastModifiedDate.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByLastModifiedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where lastModifiedDate is less than or equal to DEFAULT_LAST_MODIFIED_DATE
        defaultSysLogShouldBeFound("lastModifiedDate.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the sysLogList where lastModifiedDate is less than or equal to SMALLER_LAST_MODIFIED_DATE
        defaultSysLogShouldNotBeFound("lastModifiedDate.lessThanOrEqual=" + SMALLER_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByLastModifiedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where lastModifiedDate is less than DEFAULT_LAST_MODIFIED_DATE
        defaultSysLogShouldNotBeFound("lastModifiedDate.lessThan=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the sysLogList where lastModifiedDate is less than UPDATED_LAST_MODIFIED_DATE
        defaultSysLogShouldBeFound("lastModifiedDate.lessThan=" + UPDATED_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByLastModifiedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where lastModifiedDate is greater than DEFAULT_LAST_MODIFIED_DATE
        defaultSysLogShouldNotBeFound("lastModifiedDate.greaterThan=" + DEFAULT_LAST_MODIFIED_DATE);

        // Get all the sysLogList where lastModifiedDate is greater than SMALLER_LAST_MODIFIED_DATE
        defaultSysLogShouldBeFound("lastModifiedDate.greaterThan=" + SMALLER_LAST_MODIFIED_DATE);
    }

    @Test
    @Transactional
    void getAllSysLogsByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where delFlag equals to DEFAULT_DEL_FLAG
        defaultSysLogShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the sysLogList where delFlag equals to UPDATED_DEL_FLAG
        defaultSysLogShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSysLogsByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultSysLogShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the sysLogList where delFlag equals to UPDATED_DEL_FLAG
        defaultSysLogShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllSysLogsByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where delFlag is not null
        defaultSysLogShouldBeFound("delFlag.specified=true");

        // Get all the sysLogList where delFlag is null
        defaultSysLogShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the sysLogList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the sysLogList where deletedTime equals to UPDATED_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime is not null
        defaultSysLogShouldBeFound("deletedTime.specified=true");

        // Get all the sysLogList where deletedTime is null
        defaultSysLogShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the sysLogList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the sysLogList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the sysLogList where deletedTime is less than UPDATED_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllSysLogsByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        sysLogRepository.save(sysLog);

        // Get all the sysLogList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultSysLogShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the sysLogList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultSysLogShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingSysLog() throws Exception {
        ...
        assertThat(testSysLog.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testSysLog.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
