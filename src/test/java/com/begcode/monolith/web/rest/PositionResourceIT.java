...
public class PositionResourceIT {
    ...
    void createPosition() throws Exception {
        ...
        assertThat(testPosition.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllPositionsByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where delFlag equals to DEFAULT_DEL_FLAG
        defaultPositionShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the positionList where delFlag equals to UPDATED_DEL_FLAG
        defaultPositionShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllPositionsByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultPositionShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the positionList where delFlag equals to UPDATED_DEL_FLAG
        defaultPositionShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllPositionsByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where delFlag is not null
        defaultPositionShouldBeFound("delFlag.specified=true");

        // Get all the positionList where delFlag is null
        defaultPositionShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the positionList where deletedTime equals to UPDATED_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the positionList where deletedTime equals to UPDATED_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime is not null
        defaultPositionShouldBeFound("deletedTime.specified=true");

        // Get all the positionList where deletedTime is null
        defaultPositionShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the positionList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the positionList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the positionList where deletedTime is less than UPDATED_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllPositionsByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        positionRepository.save(position);

        // Get all the positionList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultPositionShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the positionList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultPositionShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingPosition() throws Exception {
        ...
        assertThat(testPosition.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
    ...
    void partialUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.delFlag(UPDATED_DEL_FLAG);
