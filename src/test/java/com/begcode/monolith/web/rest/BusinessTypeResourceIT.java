...
public class BusinessTypeResourceIT {
    ...
    void createBusinessType() throws Exception {
        ...
        assertThat(testBusinessType.getDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testBusinessType.getDeletedTime()).isEqualTo(DEFAULT_DELETED_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByDelFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where delFlag equals to DEFAULT_DEL_FLAG
        defaultBusinessTypeShouldBeFound("delFlag.equals=" + DEFAULT_DEL_FLAG);

        // Get all the businessTypeList where delFlag equals to UPDATED_DEL_FLAG
        defaultBusinessTypeShouldNotBeFound("delFlag.equals=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDelFlagIsInShouldWork() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where delFlag in DEFAULT_DEL_FLAG or UPDATED_DEL_FLAG
        defaultBusinessTypeShouldBeFound("delFlag.in=" + DEFAULT_DEL_FLAG + "," + UPDATED_DEL_FLAG);

        // Get all the businessTypeList where delFlag equals to UPDATED_DEL_FLAG
        defaultBusinessTypeShouldNotBeFound("delFlag.in=" + UPDATED_DEL_FLAG);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDelFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where delFlag is not null
        defaultBusinessTypeShouldBeFound("delFlag.specified=true");

        // Get all the businessTypeList where delFlag is null
        defaultBusinessTypeShouldNotBeFound("delFlag.specified=false");
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime equals to DEFAULT_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.equals=" + DEFAULT_DELETED_TIME);

        // Get all the businessTypeList where deletedTime equals to UPDATED_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.equals=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsInShouldWork() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime in DEFAULT_DELETED_TIME or UPDATED_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.in=" + DEFAULT_DELETED_TIME + "," + UPDATED_DELETED_TIME);

        // Get all the businessTypeList where deletedTime equals to UPDATED_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.in=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime is not null
        defaultBusinessTypeShouldBeFound("deletedTime.specified=true");

        // Get all the businessTypeList where deletedTime is null
        defaultBusinessTypeShouldNotBeFound("deletedTime.specified=false");
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime is greater than or equal to DEFAULT_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.greaterThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the businessTypeList where deletedTime is greater than or equal to UPDATED_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.greaterThanOrEqual=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime is less than or equal to DEFAULT_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.lessThanOrEqual=" + DEFAULT_DELETED_TIME);

        // Get all the businessTypeList where deletedTime is less than or equal to SMALLER_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.lessThanOrEqual=" + SMALLER_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime is less than DEFAULT_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.lessThan=" + DEFAULT_DELETED_TIME);

        // Get all the businessTypeList where deletedTime is less than UPDATED_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.lessThan=" + UPDATED_DELETED_TIME);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByDeletedTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.save(businessType);

        // Get all the businessTypeList where deletedTime is greater than DEFAULT_DELETED_TIME
        defaultBusinessTypeShouldNotBeFound("deletedTime.greaterThan=" + DEFAULT_DELETED_TIME);

        // Get all the businessTypeList where deletedTime is greater than SMALLER_DELETED_TIME
        defaultBusinessTypeShouldBeFound("deletedTime.greaterThan=" + SMALLER_DELETED_TIME);
    }
    ...
    void putExistingBusinessType() throws Exception {
        ...
        assertThat(testBusinessType.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testBusinessType.getDeletedTime()).isEqualTo(UPDATED_DELETED_TIME);
    }
    ...
    void partialUpdateBusinessTypeWithPatch() throws Exception {
        ...
        partialUpdatedBusinessType.description(UPDATED_DESCRIPTION).icon(UPDATED_ICON).deletedTime(UPDATED_DELETED_TIME);
