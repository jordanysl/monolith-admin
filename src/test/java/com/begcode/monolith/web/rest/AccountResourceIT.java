...
import static com.begcode.monolith.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.begcode.monolith.service.dto.PasswordChangeDTO;
...
class AccountResourceIT {
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findFirstByCode(AuthoritiesConstants.USER).orElseThrow());
    }
