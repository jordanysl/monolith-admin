        ...
        if (StringUtils.isNotEmpty(criteria.getJhiCommonSearchKeywords())) {
            if (StringUtils.isNumeric(criteria.getJhiCommonSearchKeywords())) {
                ...
                queryWrapper.and(q -> {
                    ...
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "thumb"));
    ...
    private QueryWrapper<UploadFile> createQueryWrapper(QueryWrapper<UploadFile> queryWrapper, Boolean useOr, UploadFileCriteria criteria) {
        if (criteria != null) {
            ...
            if (criteria.getThumb() != null) {
                queryWrapper = CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getThumb(), "thumb", useOr));
            }
