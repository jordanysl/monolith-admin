...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.begcode.monolith.service.EmailAlreadyUsedException ||
            ex instanceof com.begcode.monolith.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.begcode.monolith.service.InvalidPasswordException
