        ...
        if (StringUtils.isNotEmpty(criteria.getJhiCommonSearchKeywords())) {
            if (StringUtils.isNumeric(criteria.getJhiCommonSearchKeywords())) {
                ...
                queryWrapper.and(q -> {
                    ...
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "area_code"));
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "city_code"));
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "merger_name"));
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "short_name"));
                    q.or(buildStringSpecification(new StringFilter().setContains(criteria.getJhiCommonSearchKeywords()), "zip_code"));
                });
            }
        }
        return queryWrapper;
    ...
    private QueryWrapper<RegionCode> createQueryWrapper(QueryWrapper<RegionCode> queryWrapper, Boolean useOr, RegionCodeCriteria criteria) {
        if (criteria != null) {
            ...
            if (criteria.getAreaCode() != null) {
                queryWrapper =
                    CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getAreaCode(), "area_code", useOr));
            }
            if (criteria.getCityCode() != null) {
                queryWrapper =
                    CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getCityCode(), "city_code", useOr));
            }
            if (criteria.getMergerName() != null) {
                queryWrapper =
                    CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getMergerName(), "merger_name", useOr));
            }
            if (criteria.getShortName() != null) {
                queryWrapper =
                    CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getShortName(), "short_name", useOr));
            }
            if (criteria.getZipCode() != null) {
                queryWrapper = CriteriaUtil.build(useOr, queryWrapper, buildStringSpecification(criteria.getZipCode(), "zip_code", useOr));
            }
            if (criteria.getLevel() != null) {
                queryWrapper = CriteriaUtil.build(useOr, queryWrapper, buildSpecification(criteria.getLevel(), "level", useOr));
            }
            if (criteria.getLng() != null) {
                queryWrapper = CriteriaUtil.build(useOr, queryWrapper, buildRangeSpecification(criteria.getLng(), "lng", useOr));
            }
            if (criteria.getLat() != null) {
                queryWrapper = CriteriaUtil.build(useOr, queryWrapper, buildRangeSpecification(criteria.getLat(), "lat", useOr));
            }
            ...
            if (criteria.getParentName() != null) {
                queryWrapper =
                    CriteriaUtil.build(
                        useOr,
                        queryWrapper,
                        buildStringSpecification(criteria.getParentName(), "region_code_left_join.name", useOr)
                    );
            }
