...
import com.begcode.monolith.security.*;
import com.begcode.monolith.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .addFilterAt(
                new AccessSecurityInterceptor(accessSecurityMetadataSource, accessDecisionManagerImpl),
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers("/api/authenticate/withoutCaptcha").permitAll()
                    .requestMatchers("/api/authenticate/mobile").permitAll()
                    .requestMatchers("/api/mobile/smscode").permitAll()
                    .requestMatchers("/api/oauth/**").permitAll()
                    .requestMatchers("/api/randomImage/**").permitAll()
