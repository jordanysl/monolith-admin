...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.begcode.monolith.system.domain.SmsConfig.class.getName());
            ...
            createCache(cm, com.begcode.monolith.system.domain.DataPermissionRule.class.getName());
