...
public final class SecurityUtils {
    ...
    public static final String WX_SESSION_KEY = "session_key"; // add by wangxin WeiXin SESSION_KEY

    public static final String USER_ID = "userId"; // add by wangxin userId
